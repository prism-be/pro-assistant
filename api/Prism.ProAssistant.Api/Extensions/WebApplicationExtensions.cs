...
public static class WebApplicationExtensions
{
    ...
    private static string ReplaceEnvironmentVariable(string content, ILogger logger, string variable, string? value)
    {
        ...
        logger.LogInformation(content.Length == size ? 
            "The environment variable {variable} was not found in the JavaScript file" : 
            "The environment variable {variable} was replaced in the JavaScript file",
            variable);
