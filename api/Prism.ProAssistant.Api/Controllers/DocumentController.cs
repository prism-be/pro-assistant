...
public class DocumentController
{
    ...
    public DocumentController(IDataService dataService, ILogger<DocumentController> logger)
    {
    ...
    public static void WriteContactAddress(TableDescriptor table, Appointment appointment, Contact? contact)
    {
    ...
    private async Task SaveDocument(Appointment appointment, string title, byte[] bytes)
    {
        ...
        await _dataService.UpdateAsync(appointment);
