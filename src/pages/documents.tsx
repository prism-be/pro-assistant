...
const Documents: NextPage = () => {
    ...
    const {data: documents, mutate: mutateDocuments} = useSWR<DocumentConfiguration[] | null>('/data/documents-configuration/list');
                ...
                <>
                    ...
                    <div>
                        ...
                        {documents && documents.length > 0 && <>
                            {documents.map(d => <div className={"flex"} key={d._id}>
