...
const Documents: NextPage = () => {
  ...
  const [currentDocument, setCurrentDocument] =
    useState<DocumentConfiguration | null>(null);
  const {
    register,
    getValues,
    formState: { errors },
        ...
        <Section>
          <>
            ...
            <div>
              {documents?.length === 0 && (
                <>
                  <i className={"text-center italic p-4"}>
                    {t("list.NoElements")}
                  </i>
                </>
              )}
              ...
              <div>
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      <b>{"{{appointmentType}}"}</b> :{" "}
                      {t("edit.help.appointmentType")}
                    </li>
                    <li>
                      <b>{"{{appointmentDate}}"}</b> :{" "}
                      {t("edit.help.appointmentDate")}
                    </li>
                    <li>
                      <b>{"{{appointmentHour}}"}</b> :{" "}
                      {t("edit.help.appointmentHour")}
                    </li>
                    <li>
