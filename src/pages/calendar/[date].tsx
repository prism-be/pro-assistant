...
const Calendar: NextPage = () => {
  ...
  const monday = startOfWeek(
    parse(router.query.date as string, "yyyy-MM-dd", new Date()),
    { weekStartsOn: 1 }
  );
  ...
  function goPreviousWeek() {
    router.push(
      "/calendar/" + format(add(monday, { weeks: -1 }), "yyyy-MM-dd")
    );
  }
  ...
  return (
    <ContentContainer>
      <>
        <div className={"text-orange-600 text-center p-8 m sm:hidden"}>
          {t("alerts.mobileWarning")}
        </div>
