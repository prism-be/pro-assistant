...
namespace Prism.ProAssistant.Business.Tests.Queries
{
    public class SearchContactsTests
    {
        ...
        public async Task Handle_Ok()
        {
            ...
            var result = await handler.Handle(new SearchContacts(Identifier.GenerateString(), Identifier.GenerateString(), Identifier.GenerateString(), Identifier.GenerateString()), CancellationToken.None);
