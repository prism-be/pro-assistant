...
public static class LoggerExtensions
{
    ...
    public static async Task LogDataDelete(this ILogger logger, IUser user, string itemId, Func<Task> action)
    {
    ...
    public static async Task<UpsertResult> LogDataInsert(this ILogger logger, IUser user, IDataModel data, Func<Task<UpsertResult>> action)
    {
    ...
    public static async Task<UpsertResult> LogDataUpdate(this ILogger logger, IUser user, IDataModel data, Func<Task<UpsertResult>> action)
    {
    ...
    public static async Task LogPropertyManyUpdate<T>(this ILogger logger, IUser user, string propertyName, string filterProperty,
    ...
    public static async Task<string> LogPropertyUpdate<T>(this ILogger logger, IUser user, string propertyName, string id,
