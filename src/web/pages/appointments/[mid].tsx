    ...
    return <ContentContainer>
        <Section>
            ...
            <form className={""} onSubmit={handleSubmit(onSubmit)}>
                <InputText className={""} label={t("fields.lastName")} name={"lastName"} autoCapitalize={true} required={true} type={"text"} register={register} setValue={setValue} error={errors.lastName} onChange={() => startSuggestContacts()}/>
                <InputText className={""} label={t("fields.firstName")} name={"firstName"} autoCapitalize={true} required={true} type={"text"} register={register} setValue={setValue} error={errors.firstName} onChange={() => startSuggestContacts()}/>
                
                <InputDate className={""} label={t("fields.birthDate")} name={"birthDate"} required={false} type={"text"} register={register} setValue={setValue} error={errors.birthDate}/>
                <InputText className={""} label={t("fields.phoneNumber")} name={"phoneNumber"} autoCapitalize={false} required={false} type={"text"} register={register} setValue={setValue} error={errors.phoneNumber}/>

                {contactsSuggestions.length !== 0 && <div className={""}>
                    <h2>{t("pages.appointment.contactsSuggestions.title")}</h2>
                    {contactsSuggestions.map(p => <div key={p.id} className={""} onClick={() => selectContact(p)}>
                        {p.lastName} {p.firstName} {p.birthDate && p.birthDate !== "" && <>({p.birthDate})</>}
                    </div>)}
                </div>}

                <InputSelect className={""} label={t("pages.appointment.tariffs.title")} name={"tariff"} register={register} options={getTariffsOptions()} onChange={(v) => setAppointmentType(v)}/>
                <InputText className={""} label={t("fields.price")} name={"price"} required={true} type={"text"} register={register} setValue={setValue} error={errors.price}/>

                {customTitle && <InputText className={""} label={t("fields.appointmentType")} name={"type"} autoCapitalize={true} required={true} type={"text"} register={register} setValue={setValue} error={errors.type}/>}

                <Calendar className={""} value={date} onChange={(d) => selectDate(d)}/>

                <InputText className={""} label={t("fields.hour")} name={"hour"} required={true} type={"text"} register={register} setValue={setValue} error={errors.hour} onChange={() => computeDate()}/>
                <InputText className={""} label={t("fields.duration")} name={"duration"} required={true} type={"text"} register={register} setValue={setValue} error={errors.duration} onChange={() => computeDate()}/>
                <div className={""}>
                ...
                <InputSelect className={""} label={t("fields.payment")} name={"payment"} required={false} register={register} error={errors.payment} options={paymentOptions} onChange={() => updateState()}/>
                <InputSelect className={""} label={t("fields.appointmentState")} name={"state"} required={false} register={register} error={errors.payment} options={stateOptions}/>

                <Button text={t("actions.back")} secondary={true} className={""} onClick={() => router.back()}/>

                <Button text={t("actions.save")} className={""} onClick={handleSubmit(onSubmit)}/>
            </form>
        </Section>
